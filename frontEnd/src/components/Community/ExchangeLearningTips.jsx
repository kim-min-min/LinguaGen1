...
const ExchangeLearningTips = ({ setSelectedItem }) => {
  ...
  const handleRowClick = (item) => {
    ...
    navigate(`/community/exchangelearningtips/detailview/${item.idx}`);
  };


  return (
    <div className="w-full bg-white rounded-md flex flex-col p-12 justify-start items-center min-h-screen mt-8"> {/* min-height 설정 */}
